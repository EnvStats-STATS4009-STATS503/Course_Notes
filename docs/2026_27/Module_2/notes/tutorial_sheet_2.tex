...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, breakable, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, left=2mm, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, colback=white, coltitle=black]

...
\begin{tcolorbox}[enhanced jigsaw, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toprule=.15mm, toptitle=1mm, colback=white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomrule=.15mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, opacitybacktitle=0.6, left=2mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, coltitle=black, titlerule=0mm]

...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title={Level M Extra Question}, bottomrule=.15mm, coltitle=black, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, leftrule=.75mm, toprule=.15mm, titlerule=0mm, arc=.35mm, breakable, opacityback=0, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, coltitle=black, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toprule=.15mm, titlerule=0mm, arc=.35mm, breakable, opacityback=0, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm]

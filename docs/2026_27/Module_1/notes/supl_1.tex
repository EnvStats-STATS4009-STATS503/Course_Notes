...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toptitle=1mm, opacityback=0, toprule=.15mm, left=2mm, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, leftrule=.75mm, title={Task 1}, arc=.35mm, breakable, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, rightrule=.15mm, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toptitle=1mm, opacityback=0, toprule=.15mm, left=2mm, titlerule=0mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, leftrule=.75mm, title={Task 2}, arc=.35mm, breakable, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, rightrule=.15mm, bottomtitle=1mm]

...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colback=white, coltitle=black, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, breakable, opacityback=0, title={Task 1}, toprule=.15mm, leftrule=.75mm, left=2mm, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, rightrule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colback=white, coltitle=black, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, breakable, opacityback=0, title={Task 2}, toprule=.15mm, leftrule=.75mm, left=2mm, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, rightrule=.15mm, bottomrule=.15mm]

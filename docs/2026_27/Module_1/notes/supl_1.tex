...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, coltitle=black, toptitle=1mm, bottomtitle=1mm, opacityback=0, title={Task 1}, breakable, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, arc=.35mm, opacitybacktitle=0.6, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, coltitle=black, toptitle=1mm, bottomtitle=1mm, opacityback=0, title={Task 2}, breakable, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, arc=.35mm, opacitybacktitle=0.6, titlerule=0mm]

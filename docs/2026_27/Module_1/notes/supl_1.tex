...
\begin{tcolorbox}[enhanced jigsaw, title={Task 1}, colback=white, coltitle=black, leftrule=.75mm, rightrule=.15mm, breakable, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, colframe=quarto-callout-important-color-frame, opacityback=0, titlerule=0mm, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, bottomrule=.15mm, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Task 2}, colback=white, coltitle=black, leftrule=.75mm, rightrule=.15mm, breakable, colbacktitle=quarto-callout-important-color!10!white, toptitle=1mm, colframe=quarto-callout-important-color-frame, opacityback=0, titlerule=0mm, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, bottomrule=.15mm, bottomtitle=1mm]

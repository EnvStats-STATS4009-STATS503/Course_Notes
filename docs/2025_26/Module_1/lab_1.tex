...
\section{Task 1: Limits of detection}\label{sec-LoD}
...
\FunctionTok{dim}\NormalTok{(Soar)}
\end{Highlighting}
\end{Shaded}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, title={Question}, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, colback=white, titlerule=0mm, toptitle=1mm, opacityback=0, toprule=.15mm, arc=.35mm, bottomrule=.15mm, breakable, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, title={Task 1}, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, colback=white, titlerule=0mm, toptitle=1mm, opacityback=0, toprule=.15mm, arc=.35mm, bottomrule=.15mm, breakable, coltitle=black]
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{censummary}\NormalTok{(Soar}\SpecialCharTok{$}\NormalTok{Ammonia, Soar}\SpecialCharTok{$}\NormalTok{censored) }\DocumentationTok{\#\# like summary cmd but for }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
                                        \DocumentationTok{\#\# censored data}
\end{Highlighting}
\end{Shaded}

\textbf{What does this tell us?} You can ignore the limit of ``0.00'',
since the function adds this by default if there is only one positive
limit in the dataset --- you can see that \texttt{n} takes the value 0
here, meaning that there are no data points censored at 0.
...
\NormalTok{ROS }\OtherTok{\textless{}{-}} \FunctionTok{cenros}\NormalTok{(Soar}\SpecialCharTok{$}\NormalTok{Ammonia, Soar}\SpecialCharTok{$}\NormalTok{censored) }\DocumentationTok{\#\# constructs an object of }
                                           \DocumentationTok{\#\# class c("ros", "lm")}
\FunctionTok{plot}\NormalTok{(ROS)    }\DocumentationTok{\#\# probability plot}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{lab_1_files/figure-pdf/unnamed-chunk-6-2.pdf}}
...
the proportion of observations \(\neq\) to each concentration. Don't
...
are actually interestes is in the following output:
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, title={Task 2}, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, colback=white, titlerule=0mm, toptitle=1mm, opacityback=0, toprule=.15mm, arc=.35mm, bottomrule=.15mm, breakable, coltitle=black]
...
\section{Designing a monitoring network}\label{sec-design}
...
function to visualise the distribution of lakes as follow:
...
\begin{verbatim}
file:///C:/Users/admin/AppData/Local/Temp/RtmpIjunNr/file46084e034f0f/widget460824f08ef.html screenshot completed
\end{verbatim}

\pandocbounded{\includegraphics[keepaspectratio]{lab_1_files/figure-pdf/unnamed-chunk-21-1.pdf}}

\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, title={Task 3}, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, colback=white, titlerule=0mm, toptitle=1mm, opacityback=0, toprule=.15mm, arc=.35mm, bottomrule=.15mm, breakable, coltitle=black]
...
\begin{verbatim}
file:///C:/Users/admin/AppData/Local/Temp/RtmpIjunNr/file46081b3b72ae/widget46081dff60bc.html screenshot completed
\end{verbatim}
...
\begin{verbatim}
file:///C:/Users/admin/AppData/Local/Temp/RtmpIjunNr/file4608e6b5973/widget46086e521100.html screenshot completed
\end{verbatim}
...
\begin{verbatim}
file:///C:/Users/admin/AppData/Local/Temp/RtmpIjunNr/file46084a116acb/widget4608666b3952.html screenshot completed
\end{verbatim}
...
\begin{verbatim}
file:///C:/Users/admin/AppData/Local/Temp/RtmpIjunNr/file460865121c61/widget46082da2571.html screenshot completed
\end{verbatim}
...
tasked to design a river network using GRTS algorithm for a section of
the llinois River in Arkansas and Oklahoma.

\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, title={Task 4}, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, colback=white, titlerule=0mm, toptitle=1mm, opacityback=0, toprule=.15mm, arc=.35mm, bottomrule=.15mm, breakable, coltitle=black]

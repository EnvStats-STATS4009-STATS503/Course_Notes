...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, leftrule=.75mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, breakable, coltitle=black, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, colback=white, bottomrule=.15mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, leftrule=.75mm, left=2mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, breakable, coltitle=black, toprule=.15mm, colframe=quarto-callout-tip-color-frame, opacityback=0, colback=white, bottomrule=.15mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm]

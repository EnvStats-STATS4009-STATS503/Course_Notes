...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, boxrule=0pt, frame hidden, colback={codebgcolor}, enhanced]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, toptitle=1mm, left=2mm, coltitle=black, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, toprule=.15mm, breakable, bottomtitle=1mm, colback=white, titlerule=0mm, opacityback=0, bottomrule=.15mm, arc=.35mm]
...
\href{https://moodle.gla.ac.uk/pluginfile.php/9627009/mod_folder/content/0/ALMERA\%20Soil\%20Sampling\%20Tutorial\%20Sheet\%201.pdf}{on
Moodle}). Describe briefly the sampling strategy adopted and also the

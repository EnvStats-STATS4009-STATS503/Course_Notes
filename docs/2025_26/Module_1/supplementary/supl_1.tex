...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, arc=.35mm, titlerule=0mm, toprule=.15mm, colback=white, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, title={Task 1}]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, arc=.35mm, titlerule=0mm, toprule=.15mm, colback=white, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, title={Task 2}]

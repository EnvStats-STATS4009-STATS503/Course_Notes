...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, titlerule=0mm, opacityback=0, breakable, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, title={Task 1}, arc=.35mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, colframe=quarto-callout-important-color-frame, rightrule=.15mm, titlerule=0mm, opacityback=0, breakable, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, title={Task 2}, arc=.35mm, colback=white]

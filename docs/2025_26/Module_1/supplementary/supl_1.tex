...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-important-color-frame, colback=white, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, title={Task 1}, breakable, titlerule=0mm, toptitle=1mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-important-color-frame, colback=white, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, title={Task 2}, breakable, titlerule=0mm, toptitle=1mm, arc=.35mm, bottomrule=.15mm, rightrule=.15mm]

...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, arc=.35mm, rightrule=.15mm, breakable, title={Task 1}, leftrule=.75mm, opacityback=0, bottomtitle=1mm, opacitybacktitle=0.6, toprule=.15mm, titlerule=0mm, left=2mm, coltitle=black, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, arc=.35mm, rightrule=.15mm, breakable, title={Task 2}, leftrule=.75mm, opacityback=0, bottomtitle=1mm, opacitybacktitle=0.6, toprule=.15mm, titlerule=0mm, left=2mm, coltitle=black, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white]

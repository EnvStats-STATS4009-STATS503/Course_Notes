...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, rightrule=.15mm, coltitle=black, toprule=.15mm, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, bottomrule=.15mm, arc=.35mm, title={Task 1}]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toptitle=1mm, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, rightrule=.15mm, coltitle=black, toprule=.15mm, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, bottomrule=.15mm, arc=.35mm, title={Task 2}]

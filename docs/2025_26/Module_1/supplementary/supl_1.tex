...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, opacitybacktitle=0.6, titlerule=0mm, toptitle=1mm, breakable, opacityback=0, colback=white, coltitle=black, title={Task 1}, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, colframe=quarto-callout-important-color-frame, arc=.35mm, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, opacitybacktitle=0.6, titlerule=0mm, toptitle=1mm, breakable, opacityback=0, colback=white, coltitle=black, title={Task 2}, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, colframe=quarto-callout-important-color-frame, arc=.35mm, toprule=.15mm, leftrule=.75mm]

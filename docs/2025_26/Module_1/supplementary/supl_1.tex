...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, breakable, opacitybacktitle=0.6, arc=.35mm, title={Task 1}, titlerule=0mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, left=2mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, opacityback=0, bottomtitle=1mm, toptitle=1mm, coltitle=black, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, breakable, opacitybacktitle=0.6, arc=.35mm, title={Task 2}, titlerule=0mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, left=2mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, opacityback=0, bottomtitle=1mm, toptitle=1mm, coltitle=black, bottomrule=.15mm]

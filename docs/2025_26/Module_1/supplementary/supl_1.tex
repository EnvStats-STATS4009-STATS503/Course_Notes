...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacitybacktitle=0.6, colback=white, breakable, title={Task 1}, bottomtitle=1mm, left=2mm, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-important-color-frame, coltitle=black, titlerule=0mm, toprule=.15mm, opacityback=0, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacitybacktitle=0.6, colback=white, breakable, title={Task 2}, bottomtitle=1mm, left=2mm, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-important-color-frame, coltitle=black, titlerule=0mm, toprule=.15mm, opacityback=0, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white]

...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, coltitle=black, bottomrule=.15mm, opacityback=0, breakable, toptitle=1mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, arc=.35mm, rightrule=.15mm, left=2mm, titlerule=0mm, bottomtitle=1mm, colframe=quarto-callout-important-color-frame, leftrule=.75mm, title={Task 1}]

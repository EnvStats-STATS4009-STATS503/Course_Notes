...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, opacityback=0, arc=.35mm, toprule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, breakable, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, opacityback=0, arc=.35mm, toprule=.15mm, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, breakable, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, left=2mm, leftrule=.75mm]

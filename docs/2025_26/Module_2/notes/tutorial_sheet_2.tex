...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, sharp corners, breakable, colback={codebgcolor}, enhanced, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colback=white, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, titlerule=0mm, opacityback=0, breakable, toptitle=1mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, leftrule=.75mm, left=2mm]

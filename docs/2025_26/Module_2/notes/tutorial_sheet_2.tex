...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, coltitle=black, rightrule=.15mm, leftrule=.75mm, breakable, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, opacityback=0, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, colback=white, left=2mm, opacitybacktitle=0.6, toprule=.15mm]

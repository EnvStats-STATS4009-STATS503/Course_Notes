...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacityback=0, rightrule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colback=white, arc=.35mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, titlerule=0mm]
